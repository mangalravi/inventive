...
$(document).ready(function () {
  ...
  var swiper = new Swiper(".swiper1", {
    ...
    breakpoints: {
      480: {
        slidesPerView: 1, // Show only 1 slide per view on mobile (viewport width <= 480px)
        spaceBetween: 20,
      },
    },
  });
...
(function ($) {
  ...
  $(document).ready(function () {
    $("#line").click(function () {
      $("#line").hide();
      $("#cross").show();
      $(".collapse.navbar-collapse").show().css("height", "100%");
      $(".exbtn").show();
    });
    ...
    $("#cross").click(function () {
      $("#cross").hide();
      $("#line").show();
      $(".collapse.navbar-collapse").hide().css("height", "");
      $(".exbtn").hide();
    });
  });
})(jQuery);
