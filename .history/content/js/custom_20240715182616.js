...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Add focus event listener to the <a> element
  linkElement.addEventListener("focus", function () {
    // Check if submenu exists and is hidden
    if (submenu && submenu.style.display === "none") {
      submenu.style.display = "block";
    }
  });

  // Add blur event listener to hide submenu when focus is lost
  linkElement.addEventListener("blur", function () {
    // Check if submenu exists and is visible
